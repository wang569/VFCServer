 ...
 */
            ...
            /**
            *  TSrcJobInfo bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TSrcJobInfo
    ...
    public static class Factory{
        ...
        */
        public static TSrcJobInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TSrcJobInfo object =
                new TSrcJobInfo();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"TSrcJobInfo".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TSrcJobInfo)fhzvfc.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
