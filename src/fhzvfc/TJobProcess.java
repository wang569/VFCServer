 ...
 */
            ...
            /**
            *  TJobProcess bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TJobProcess
    ...
    public static class Factory{
        ...
        */
        public static TJobProcess parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TJobProcess object =
                new TJobProcess();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"TJobProcess".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TJobProcess)fhzvfc.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
