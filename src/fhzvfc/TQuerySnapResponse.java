 ...
 */
            ...
            /**
            *  TQuerySnapResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TQuerySnapResponse
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = TQuerySnapResponse
                ...
                */
                        ...
                        */
                                    ...
                                    protected fhzvfc.TSnapInfo[] localSnapInfo ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localSnapInfoTracker = false ;

                           public boolean isSnapInfoSpecified(){
                               return localSnapInfoTracker;
                           }
                           ...
                           /**
                           * Auto generated getter method
                           * @return fhzvfc.TSnapInfo[]
                           */
                           public  fhzvfc.TSnapInfo[] getSnapInfo(){
                               return localSnapInfo;
                           }
                              ...
                              /**
                               * validate the array for SnapInfo
                               */
                              protected void validateSnapInfo(fhzvfc.TSnapInfo[] param){
                             ...
                             /**
                              * Auto generated setter method
                              * @param param SnapInfo
                              */
                              public void setSnapInfo(fhzvfc.TSnapInfo[] param){
                              
                                   validateSnapInfo(param);

                               localSnapInfoTracker = param != null;
                                      
                                      this.localSnapInfo=param;
                              }
                             ...
                             * @param param fhzvfc.TSnapInfo
                             */
                             public void addSnapInfo(fhzvfc.TSnapInfo param){
                                   if (localSnapInfo == null){
                                   localSnapInfo = new fhzvfc.TSnapInfo[]{};
                                   }

                            
                                 //update the setting tracker
                                localSnapInfoTracker = true;
                            

                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localSnapInfo);
                               list.add(param);
                               this.localSnapInfo =
                             (fhzvfc.TSnapInfo[])list.toArray(
                            new fhzvfc.TSnapInfo[list.size()]);
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":TQuerySnapResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "TQuerySnapResponse",
                           xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                              if (localSnapInfoTracker){
                                       if (localSnapInfo!=null){
                                            for (int i = 0;i < localSnapInfo.length;i++){
                                                if (localSnapInfo[i] != null){
                                                 localSnapInfo[i].serialize(new javax.xml.namespace.QName("","SnapInfo"),
                                                           xmlWriter);
                                                } else {
                                               ...
                                               throw new org.apache.axis2.databinding.ADBException("SnapInfo cannot be null!!");
    ...
    public static class Factory{
        ...
        */
        public static TQuerySnapResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TQuerySnapResponse object =
                new TQuerySnapResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"TQuerySnapResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TQuerySnapResponse)fhzvfc.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list4 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","SnapInfo").equals(reader.getName()) || new javax.xml.namespace.QName("","SnapInfo").equals(reader.getName()) ){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    
                                    list4.add(fhzvfc.TSnapInfo.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone4){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("","SnapInfo").equals(reader.getName())){
                                                                    list4.add(fhzvfc.TSnapInfo.Factory.parse(reader));
                                                        ...
                                                        object.setSnapInfo((fhzvfc.TSnapInfo[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                fhzvfc.TSnapInfo.class,
                                                                list4));
