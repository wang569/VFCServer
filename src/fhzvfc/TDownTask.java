 ...
 */
            ...
            /**
            *  TDownTask bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TDownTask
                ...
                */
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           protected boolean localFileUriTracker = false ;

                           public boolean isFileUriSpecified(){
                               return localFileUriTracker;
                           }
                           ...
                           */
                           public  java.lang.String[] getFileUri(){
                              ...
                              /**
                               * validate the array for FileUri
                               */
                              protected void validateFileUri(java.lang.String[] param){
                              ...
                              */
                              public void setFileUri(java.lang.String[] param){
                                   ...
                                   validateFileUri(param);

                               localFileUriTracker = param != null;
                             ...
                             */
                             public void addFileUri(java.lang.String param){
                                   if (localFileUri == null){
                                   localFileUri = new java.lang.String[]{};
                                   }

                            
                                 //update the setting tracker
                                localFileUriTracker = true;
                            

                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localFileUri);
                               list.add(param);
                               this.localFileUri =
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                              if (localFileUriTracker){
                             if (localFileUri!=null) {
                                   namespace = "";
                                   for (int i = 0;i < localFileUri.length;i++){
                                        
                                            if (localFileUri[i] != null){
                                        
                                                writeStartElement(null, namespace, "FileUri", xmlWriter);

                                            
                                                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localFileUri[i]));
    ...
    public static class Factory{
        ...
        */
        public static TDownTask parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TDownTask object =
                new TDownTask();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"TDownTask".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TDownTask)fhzvfc.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                                    ...
                                    list4.add(reader.getElementText());
                                            ...
                                            while(!loopDone4){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("","FileUri").equals(reader.getName())){
                                                         list4.add(reader.getElementText());
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setFileUri((java.lang.String[])
