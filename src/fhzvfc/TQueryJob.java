 ...
 */
            ...
            /**
            *  TQueryJob bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TQueryJob
    ...
    public static class Factory{
        ...
        */
        public static TQueryJob parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TQueryJob object =
                new TQueryJob();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"TQueryJob".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TQueryJob)fhzvfc.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
